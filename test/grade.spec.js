...
describe("PercentageCalculation And Grade",()=>{
    ...
    it("When Total No of testcases are less than zero ",()=>{
        var gradeInvalid1 = {
            'buildNumber': '123456',
            'total': -1,
            'passed': 450,
    ...
    it("when skipped test cases are less than 0",()=>{
        var gradeInvalid4 = {
            'buildNumber': '123456',
            'total': 150,
            'passed': 0,
    ...
    it("when aborted test cases are less than 0",()=>{
        var gradeInvalid5 = {
            'buildNumber': '123456',
            'total': 1000,
            'passed': 600,
    ...
    it("when total skipped test cases are greater than total test cases",()=>{
        var gradeInvalid6 = {
            'buildNumber': '123456',
            'total': 100,
            'passed': 60,
    ...
    it("when passed test cases are greater than to total test cases",()=>{
        var gradeInvalid7 = {
            'buildNumber': '123456',
            'total': 100,
            'passed': 600,
